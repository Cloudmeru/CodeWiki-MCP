...
class TestExtractDiagrams:
    ...
    def test_codewiki_spa_diagram(self):
        """CodeWiki SPA renders diagrams as <code-documentation-diagram-inline>
    ...
    def test_codewiki_graphviz_diagram(self):
        """CodeWiki Graphviz SVGs have <g class='node'> and <g class='edge'>
...
class TestFetchWikiPage:
    def test_calls_playwright(self, mocker):
        ...
        mocker.patch(
            "codewiki_mcp.parser._fetch_html",
