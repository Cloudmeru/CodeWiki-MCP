"""Tests for codewiki_mcp.tools._helpers — post-v1.1.0 additions.

Covers: pre_resolve_keyword, build_resolution_note, build_codewiki_url,
...
from codewiki_mcp.tools._helpers import (
    _is_not_indexed,
...
from codewiki_mcp.types import ErrorCode, ToolResponse
...
def _sr(owner: str, repo: str, stars: int = 0):
    from codewiki_mcp.resolver import SearchResult
...
# build_codewiki_url
# ---------------------------------------------------------------------------
class TestBuildCodewikiUrl:
    def test_https_url(self):
        assert build_codewiki_url("https://github.com/microsoft/vscode") == (
            "https://codewiki.google/github.com/microsoft/vscode"
        )

    def test_http_url(self):
        assert build_codewiki_url("http://github.com/owner/repo") == (
            "https://codewiki.google/github.com/owner/repo"
        )

    def test_already_plain(self):
        assert build_codewiki_url("github.com/owner/repo") == (
            "https://codewiki.google/github.com/owner/repo"
        )
...
class TestPreResolveKeyword:
    ...
    def test_bare_keyword_resolved(self, mocker):
        mocker.patch(
            "codewiki_mcp.tools._helpers.resolve_keyword_interactive",
...
class TestBuildResolutionNote:
    ...
    def test_keyword_with_results(self, mocker):
        ...
        mocker.patch(
            "codewiki_mcp.tools._helpers.resolve_keyword",
...
class TestFetchPageOrError:
    ...
    def test_rate_limited(self, mocker):
        mocker.patch(
            "codewiki_mcp.tools._helpers.validate_topics_input",
